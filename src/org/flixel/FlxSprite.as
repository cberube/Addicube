	...
	*/
	public class FlxSprite extends FlxObject
	{
		...
		*/
		...
		/**
		 * Switches this sprite's animation to the specified animation without
		 * restarting the animation process. (i.e. the new animation will begin
		 * at the same frame as the current animation is displaying.)
